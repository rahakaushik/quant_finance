...
<html lang="en" class="no-js">
	...
	<body>
		<div class="container">
			...
			<div class="main">
                            <p><font color="black">
                            We monitor weekly earnings and analyse historic trends for price of the stock after earnings are reported. These can generate trade signals and guide investment strategies
					...
					<li>
						<h3 class="cbp-nttrigger">Earnings Trends</h3>
						<div class="cbp-ntcontent">
							<p>We surface the stocks which will report earnings this coming week. Often after earnings reports stock prices can move higher or lower 
                                presenting an investment opportunity. Our algorithms crunch the historical earnings surprises and assess the correlation of earnings with price. Below are stocks which have risen after earnings report if earnings beat expectations. The stocks with low, medium and high probabilty of price movement are reported below.  
					...
					<li>
						...
						<div class="cbp-ntcontent">
							<p>Shown below are all the stocks which will report their earnings this week. In addition to our predictions, the stocks below should also be considered potential source of trade ideas</p>
							<ul class="cbp-ntsubaccordion">
								<li>
									<h4 class="cbp-nttrigger">Explore</h4>
									<div class="cbp-ntcontent">
                                                                            <p>

                                                                            <!--?php 
                                                                            $f = file_get_contents("https://qntafi.s3.amazonaws.com/earnings_w.html");
                                                                            echo $f;
                                                                            ?-->
                                                                            <iframe src="https://qntafi.s3.amazonaws.com/earnings_w.html" width=100% height="100px"></iframe>
                                                                            </p>
                                                                        </div>
								</li>
